...
def aplicar_carta(numero, estado):
    ...
    #   - Pierdes 1 empleado.
        ...
        # si hay mantenimiento entonces no pasa nada con esta carta
        if estado["MantenimientoHecho"] and estado["TurnosMantenimiento"] > 0:
            return estado
    ...
    # Duración: 2 turnos
        ...
        estado["Ventas"] = 0.75 * estado["Ventas"]
